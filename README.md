...
1. Run `bundle install` to install ruby dependencies. If you get errors, delete Gemfile.lock and try again. Additionally, make sure you have run `sudo apt-get install libxslt-dev libxml2-dev`.
